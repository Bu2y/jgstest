...
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/css/sms.css" />
...
<div id="loginForm" class="userForm png">
	<form method="post" name="loginform" action="/userlogin/aaa?action=login" onsubmit = "return check()">
		<dl>			
